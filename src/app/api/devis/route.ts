...
<p style="margin-top:24px;color:#6b7280;">À très bientôt,<br/><strong style="color:#111827;">KAH Digital</strong> · <a href="https://kah-digital.ch" style="color:#6366f1;">KAH Digital.ch</a></p>
</div>`,
        }),
      }).catch(console.error);
    }
