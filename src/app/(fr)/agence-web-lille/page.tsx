...
export const metadata: Metadata = {
  title: "Création site web Lille — KAH-Digital | Dès € 300",
  ...
  openGraph: { title: "Création site web Lille — KAH-Digital", description: "Studio digital pour entreprises lilloises. Sites, apps, IA. Dès € 300." },
