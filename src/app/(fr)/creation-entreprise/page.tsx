...
export const metadata = buildPageMetadata({
  ...
  title: "Création d'auto-entreprise via l'INPI | KAH Digital",
  description: "On s'occupe de ton immatriculation auto-entrepreneur à l'INPI : rapide, sans erreur. Réponse sous 24h, offert avec un pack site.",
