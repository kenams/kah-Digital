...
export const metadata: Metadata = {
  title: "Création site web Montpellier — KAH-Digital | Dès € 300",
  ...
  openGraph: { title: "Création site web Montpellier — KAH-Digital", description: "Studio digital pour entreprises montpelliéraines. Sites, apps. Dès € 300." },
