...
export const metadata: Metadata = {
  title: "Création site web Toulouse — KAH-Digital | Dès € 300",
  ...
  openGraph: { title: "Création site web Toulouse — KAH-Digital", description: "Studio digital pour entreprises toulousaines. Sites, apps, IA. Dès € 300." },
