...
export const metadata: Metadata = {
  title: "Création site web Bâle — KAH-Digital | Dès CHF 300",
  ...
  openGraph: { title: "Création site web Bâle — KAH-Digital", description: "Studio digital trilingue pour entreprises bâloises. Pharma, PME. Dès CHF 300." },
