...
export const metadata: Metadata = {
  title: "Création site web Rennes — KAH-Digital | Dès € 300",
  ...
  openGraph: { title: "Création site web Rennes — KAH-Digital", description: "Studio digital pour entreprises rennaises. Sites, apps, IA. Dès € 300." },
