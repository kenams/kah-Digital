    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="flex flex-col gap-3">
          <Link
            href={devisUrl}
            className="flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-violet-600 px-8 py-4 font-bold text-white shadow-lg shadow-blue-500/25 transition hover:shadow-blue-500/40"
          >
            {c.ctaQuote} <FiArrowRight size={16} />
          </Link>
          <a
            href={waUrl}
            target="_blank"
          ...
          <a
            href={`mailto:${email}?subject=Suite — ${encodeURIComponent(name)}&body=Bonjour Kénan,%0A%0AJ'ai vu votre analyse de mon site ${prospect.website}.%0A%0A`}
