...
const contactRoles = ["Management", "Booking", "Press", "Communication"];
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3 text-sm text-white/70">
                ...
                <span className="rounded-full border border-white/25 px-4 py-2">Outcome: {project.result}</span>
              </div>
            </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <Reveal>
              <div className="rounded-[32px] border border-slate-200 bg-slate-50 p-8 shadow-sm">
                <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Live site structure</p>
                <h2 className="mt-3 text-3xl font-bold text-slate-950">What the live website actually shows today.</h2>
            ...
            <Reveal>
              <div className="rounded-[32px] border border-slate-200 bg-slate-50 p-8 shadow-sm">
                <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Business contacts</p>
                <h2 className="mt-3 text-3xl font-bold text-slate-950">Clear entry points depending on the request.</h2>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Reveal>
              <div className="rounded-[32px] border border-slate-200 bg-slate-50 p-8 shadow-sm">
                ...
                <h2 className="mt-3 text-3xl font-bold text-slate-950">The real need behind the project.</h2>
            ...
            <Reveal>
              <div className="rounded-[32px] border border-slate-200 bg-slate-50 p-8 shadow-sm">
                <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Delivered outcome</p>
                <h2 className="mt-3 text-3xl font-bold text-slate-950">What this version concretely improves.</h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-semibold">Delivered visuals supporting the project.</h2>
            </div>
            ...
            <div className="rounded-[32px] bg-white p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)] ring-1 ring-slate-200">
              <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
                <div>
                  ...
                  <h2 className="mt-3 text-3xl font-bold text-slate-950">Need this level of result for your own website?</h2>
                  <p className="mt-4 text-lg text-slate-600">
                    KAH-Digital can scope, design, and deliver a clean base for a label, a brand, or a project that needs to
                    present its universe, content, and contact points in a stronger way.
                  </p>
                </div>
