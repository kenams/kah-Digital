...
const WA_AUDIT_URL = "https://wa.me/33759558414?text=Hi%20KAH%20Digital%2C%20I%27d%20like%20a%20free%20audit%20of%20my%20website.";
    ...
    <div className="min-h-screen bg-gray-950 text-white">
        ...
        <div>
          <form onSubmit={handleSubmit} className="premium-card relative overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur sm:p-8 space-y-4">
            ...
            <div className="relative">
              <label className="mb-1.5 block text-sm font-medium text-white/85">Company name *</label>
              <input
                type="text"
            ...
            <div className="relative">
              <label className="mb-1.5 block text-sm font-medium text-white/85">Website URL *</label>
              <input
                type="url"
                required
                value={form.website}
            ...
            <div className="relative">
              <label className="mb-1.5 block text-sm font-medium text-white/85">Your email *</label>
              <input
                type="email"
                required
                value={form.email}
            ...
            <div className="relative">
              <label className="mb-1.5 block text-sm font-medium text-white/85">Phone (optional)</label>
              <input
                type="tel"
                value={form.phone}
            ...
            {state === "error" && (
              <p role="status" className="relative rounded-xl border border-rose-500/25 bg-rose-500/10 px-4 py-3 text-sm text-rose-200">An error occurred. Please retry or email contact@kah-digital.ch.</p>
            )}
            <button
              type="submit"
            ...
            >
              {state === "loading" ? (
                ...
                <>Launch my free audit <FiArrowRight size={16} /></>
              )}
            </button>
            <p className="relative text-center text-xs text-gray-600">No credit card · Results by email · 100% free</p>
          </form>
      ...
      <section className="border-t border-white/6 bg-gradient-to-r from-blue-950/60 to-violet-950/40 py-14">
        <div className="mx-auto max-w-2xl px-4 text-center">
          ...
          <p className="mb-8 text-gray-400">Each audit is prepared manually by our studio. Spots are limited to guarantee quality.</p>
