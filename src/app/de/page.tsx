...
const services = [
  {
    ...
    body: "Klare Websites fuer Positionierung, Angebote, Kontakt und Sichtbarkeit.",
    href: "/de/services/site-web",
  },
  {
    title: "Web- und Mobile-Apps",
    body: "Portale, interne Tools, MVPs und Anwendungen fuer Teams und Kunden.",
    href: "/de/services/applications",
  },
  {
    title: "Support-Workflow mit GLPI",
    body: "Virtuelle Hilfe, saubere Anfragefuehrung und Ticket-Uebergabe an GLPI.",
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg text-white/72">
                Aus Lausanne entwickelt KAH-Digital klare Websites, nuetzliche Anwendungen und strukturierte digitale
                Workflows fuer Unternehmen in der Schweiz und international.
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-2 text-sm text-white/70">Schweiz als Basis, international offen.</p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-2 text-sm text-white/70">Klare Produktion ohne unnoetige Schleifen.</p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-2 text-sm text-white/70">Websites, Anwendungen und Support-Loesungen.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-bold text-slate-950">Drei klare Arbeitsfelder.</h2>
            <p className="mt-4 text-lg text-slate-600">
              Keine aufgeblasene Agentur-Rhetorik. Nur die Leistungen, die fuer Unternehmen wirklich nuetzlich sind.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="text-white">
              ...
              <h2 className="mt-3 text-3xl font-bold">Ein sichtbares Projekt, sauber praesentiert.</h2>
              <p className="mt-3 max-w-3xl text-white/70">
                KAH Prod zeigt, wie KAH-Digital ein echtes Markenuniversum in eine klare, hochwertige Website uebersetzt.
              </p>
            </div>
            <Link
              href="/de/projets"
      ...
      <section className="bg-slate-100 py-16">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8">
          <div className="rounded-[32px] bg-white p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)] ring-1 ring-slate-200">
            ...
            <h2 className="mt-3 text-3xl font-bold text-slate-950">Ein klares Briefing ist der schnellste Start.</h2>
            <p className="mt-4 text-lg text-slate-600">
              Wenn du eine Website, eine App oder einen Support-Workflow sauber strukturieren willst, starten wir mit einer
