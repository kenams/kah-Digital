...
const TARGETS = [
  ...
  { query: "photographer sydney wedding website portfolio", country: "AU", lang: "en", sector: "photographer" },
  { query: "interior designer melbourne website studio", country: "AU", lang: "en", sector: "design" },
  { query: "accountant small business brisbane website", country: "AU", lang: "en", sector: "accountant" },
  { query: "cafe coffee shop perth website contact", country: "AU", lang: "en", sector: "restaurant" },
  { query: "real estate agency gold coast website", country: "AU", lang: "en", sector: "real-estate" },
  { query: "yoga pilates studio auckland nz website", country: "NZ", lang: "en", sector: "fitness" },
  { query: "boutique hotel bed breakfast australia website", country: "AU", lang: "en", sector: "hotel" },
  { query: "digital marketing consultant freelance sydney website", country: "AU", lang: "en", sector: "consultant" },
  { query: "dentist dental clinic brisbane website", country: "AU", lang: "en", sector: "dentist" },
  { query: "architect architecture firm melbourne website", country: "AU", lang: "en", sector: "architect" },
