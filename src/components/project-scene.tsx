...
const projectSceneMapFr: Record<string, ProjectScene> = {
  "kah-prod": {
    badge: "Label",
    hero: "Label, artistes, sorties, clips et contacts métier",
    statLabel: "Sections",
    statValue: "7",
    chip: "Label independant",
    callout: "Navigation claire pour présenter l'univers du label et séparer management, booking, presse et communication.",
    footer: "Next.js / Vercel",
  },
  aurea: {
    badge: "Premium",
    hero: "Site luxe + formulaires qualifiés",
    statLabel: "Lancement",
    statValue: "3 sem.",
    chip: "Grands comptes",
  ...
  "atelier-nomade": {
    ...
    statValue: "+40%",
    chip: "5 semaines",
    callout: "Histoire, moodboard, briefs pré-remplis.",
    footer: "7 pages / Sanity",
  },
  "lumea-skin": {
    badge: "Shopflow",
    hero: "Routine personnalisée & panier intelligent",
  ...
  novapay: {
    ...
    hero: "Landing claire + chiffres animés",
    statLabel: "Demos",
    statValue: "x2",
    chip: "3 semaines",
  ...
  "valoris-conseil": {
    badge: "Editorial",
    hero: "Site bilingue + exports PDF instantanés",
    statLabel: "Prod time",
    statValue: "x3",
    chip: "6 semaines",
    callout: "Filtres multi-critères + fiches missions.",
    footer: "Contentful / Next.js",
  },
  "pulse-studio": {
    badge: "Events",
    hero: "Portfolio fullscreen + brief connecté",
    statLabel: "Pipeline",
    statValue: "x1.8",
    chip: "4 semaines",
    callout: "Carrousel GSAP + formulaire multi-étapes.",
