...
const SERVICES: Service[] = [
  ...
  },
  {
    id: "site-premium",
    emoji: "✨",
    label:      { fr: "Site premium",          en: "Premium website" },
    shortDesc:  { fr: "Design sur-mesure, animations, blog",      en: "Custom design, animations, blog" },
    priceLabel: "from 1 500 €",
    delayLabel: { fr: "3–5 semaines",          en: "3–5 weeks" },
    projectType:{ fr: "Site vitrine premium",  en: "Premium website" },
    budget: "1 500 € – 3 000 €",
  },
  {
    id: "ecommerce",
  ...
  },
  {
    ...
    priceLabel: "from 1 500 €",
    delayLabel: { fr: "3–6 semaines",          en: "3–6 weeks" },
  ...
  },
  {
    ...
    delayLabel: { fr: "6–10 semaines",         en: "6–10 weeks" },
