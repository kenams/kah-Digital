...
const PLANS = {
  fr: [
    ...
    },
    {
      ...
      badge: "IA incluse",
      badgeStyle: "amber",
      tagline: "Un système complet avec IA qui travaille pour vous 24h/24, qualifie vos leads et génère des clients.",
      delivery: "Livré en 28 jours",
      highlight: false,
      accent: "amber",
      includes: [
        "Tout le plan Business",
        "Chatbot IA personnalisé (GPT-4)",
  ...
  en: [
    ...
    },
    {
      ...
      badge: "AI included",
      badgeStyle: "amber",
      tagline: "A complete AI system working 24/7 to qualify leads and bring clients on autopilot.",
      delivery: "Delivered in 28 days",
      highlight: false,
      accent: "amber",
      includes: [
        "Everything in Business",
        "Custom AI chatbot (GPT-4)",
  ...
  de: [
    ...
    },
    {
      ...
      badge: "KI inklusive",
      badgeStyle: "amber",
      tagline: "Ein komplettes KI-System, das 24/7 Leads qualifiziert und automatisch Kunden generiert.",
      delivery: "Geliefert in 28 Tagen",
      highlight: false,
      accent: "amber",
      includes: [
        "Alles aus Business",
        "Individueller KI-Chatbot (GPT-4)",
...
export function PricingSection() {
  ...
  const copy =
    isEN ? {
      ...
      sub: "Attract with $142 · Convert with $390 · Dominate with $890. Each plan is a step toward more clients.",
      ...
      sub: "Einstieg mit CHF 149 · Konvertieren mit CHF 420 · Dominieren mit CHF 950. Jeder Plan bringt mehr Kunden.",
      ...
      sub: "Attirez avec 142 € · Convertissez avec 390 € · Dominez avec 890 €. Chaque plan est une étape vers plus de clients.",
