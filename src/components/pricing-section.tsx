...
export function PricingSection() {
  ...
  const copy =
    isEN ? {
      ...
      sub: "Attract with $142 · Convert with $790 · Get your vertical AI agent from $1,690. Each plan is a step toward autonomy.",
      ...
      sub: "Einstieg mit CHF 149 · Konvertieren mit CHF 790 · Ihr vertikaler KI-Agent ab CHF 1'690. Jeder Plan ist ein Schritt zur Autonomie.",
      ...
      sub: "Attirez avec 142 € · Convertissez avec 790 € · Votre agent IA vertical dès 1 690 €. Chaque plan est une étape vers l'autonomie.",
