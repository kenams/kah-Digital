...
const fieldsFr: BriefField[] = [
  ...
  { id: "budget", label: "Budget disponible", placeholder: "A discuter, limité, évolutif..." },
...
const fieldsEn: BriefField[] = [
  ...
  { id: "budget", label: "Available budget", placeholder: "To discuss, limited, scalable..." },
...
const fieldsDe: BriefField[] = [
  ...
  { id: "budget", label: "Verfuegbares Budget", placeholder: "Zu besprechen, begrenzt, skalierbar..." },
  ...
  const textCopy =
    locale === "en"
      ? {
          ...
          pdfContact: "Contact: contact@kah-digital.ch - +33 7 59 55 84 14 (temporary number)",
      ...
      : {
            ...
            pdfContact: "Contact : contact@kah-digital.ch - +33 7 59 55 84 14 (numero temporaire)",
