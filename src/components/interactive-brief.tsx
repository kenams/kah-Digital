...
const fieldsFr: BriefField[] = [
  ...
  { id: "budget", label: "Budget estime", placeholder: "2 000 € - 6 000 €" },
...
const fieldsEn: BriefField[] = [
  ...
  { id: "budget", label: "Estimated budget", placeholder: "€ 2,000 - 6,000" },
...
const fieldsDe: BriefField[] = [
  ...
  { id: "budget", label: "Geschaetztes Budget", placeholder: "€ 2'000 - 6'000" },
