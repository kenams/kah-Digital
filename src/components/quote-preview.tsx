...
export function QuotePreview({ clientName, clientCompany, items, total = 2800, validUntil }: QuotePreviewProps) {
  ...
  const copy = {
    ...
    de: {
      ...
      documentBody: "KAH-Digital Geschaeftsdokument",
      from: "Von",
      to: "Fuer",
      ...
      conditionItems: [
        `Alle Betraege sind in ${currency} angegeben.`,
        "Zahlung per Bankueberweisung an die Angaben aus der bestaetigten Offerte oder Rechnung.",
        "Bei laengeren Projekten kann direkt in der Offerte ein Zahlungsplan angegeben werden (Akonto + Schlusszahlung).",
        "Lieferung in 4-6 Wochen je nach Komplexitaet.",
        "Der Projektstart erfolgt nach Bestaetigung der Offerte und Eingang der ersten Zahlung, falls relevant.",
      ],
      client: "Kunde",
