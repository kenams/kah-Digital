...
const COPY = {
  fr: {
    ...
    intro: "KAH Digital conçoit des agents IA packagés, opérationnels en 10 jours. Prospection, support, devis, casting — chaque agent est formé sur votre métier et livré avec le code source. Résultats mesurables dès J+30 ou on corrige gratuitement.",
  ...
  en: {
    ...
    intro: "KAH Digital builds packaged AI agents, live in 10 days. Prospecting, support, quotes, casting — each agent is trained on your business and delivered with full source code. Measurable results by D+30 or we fix it for free.",
  ...
  de: {
    ...
    intro: "KAH Digital entwickelt fertige KI-Agenten, die in 10 Tagen live gehen. Akquise, Support, Angebote, Casting — jeder Agent wird auf Ihr Geschäft trainiert und mit vollständigem Quellcode geliefert. Messbare Ergebnisse bis T+30 oder wir korrigieren kostenlos.",
