...
const copy = {
  ...
  de: {
    ...
    sections: [
      ...
      { title: "Rechtsgrundlage", list: ["Eure ausdrückliche Einwilligung", "Vorvertragliche Maßnahmen", "Unsere berechtigten Interessen", "Gesetzliche Verpflichtungen"] },
      ...
      { title: "Weitergabe von Daten", list: ["Technische Dienstleister für Hosting, E-Mail oder Projekttools", "Partner im Rahmen von Projekten", "Behörden bei gesetzlicher Pflicht"] },
      { title: "Vertraulichkeit bei Projektaustausch", body: "Funktionale, technische, kommerzielle oder organisatorische Informationen, die im Rahmen eines Kontakts, Briefings, einer Demo, Offerte oder Scoping-Phase geteilt werden, behandeln wir als vertraulich, soweit dies für Projektprüfung, Auftragserfüllung oder rechtliche Pflichten notwendig ist." },
      { title: "Sicherheit", body: "Wir setzen geeignete technische und organisatorische Maßnahmen ein, um eure Daten vor unbefugtem Zugriff, Verlust, Veränderung oder Offenlegung zu schützen." },
      { title: "Eure Rechte", body: `Ihr habt Rechte auf Auskunft, Berichtigung, Löschung, Datenportabilität und Widerspruch. Zur Ausübung dieser Rechte erreicht ihr uns unter ${companyConfig.email}.` },
      { title: "Cookies", body: "Diese Website verwendet keine Marketing-Cookies. Es können technisch notwendige Cookies für Navigation und Formulare eingesetzt werden." },
      { title: "Kontakt", body: `Bei Fragen zu dieser Datenschutzerklärung: ${companyConfig.email}, ${companyConfig.address}, ${companyConfig.city}, ${companyConfig.country}.` },
      { title: "Änderungen", body: "Diese Richtlinie kann aktualisiert werden. Die jeweils aktuelle Version steht immer auf dieser Seite." },
    ],
