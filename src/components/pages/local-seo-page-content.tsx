...
export const CITY_PAGES: Record<string, CityPageData> = {
  "site-web-lausanne": {
    ...
    intro: "KAH Digital est bas� � Lausanne. Nous cr�ons des sites web haute-performance sur Next.js 15 pour les PME, ind�pendants et startups vaudoises. Design SaaS-level, Core Web Vitals 95+, SEO technique int�gr�. Starter d�s CHF 149 � Business d�s CHF 890 � Syst�me IA complet d�s CHF 1'690. Devis gratuit en 24h, sans engagement.",
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � Lausanne ?", a: "Starter (landing page) d�s CHF 149, livr� en 5 jours. Business (jusqu'� 6 pages, SEO) d�s CHF 890, livr� en 14 jours. Syst�me complet avec IA d�s CHF 1'690. Prix fixe garanti avant de commencer, z�ro surprise." },
  ...
  "site-web-geneve": {
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � Gen�ve ?", a: "Starter (landing page) d�s CHF 149, livr� en 5 jours. Business (6 pages, SEO multilingue) d�s CHF 890. Syst�me IA complet d�s CHF 1'690. Prix fixe confirm� avant tout d�marrage." },
  ...
  "site-web-fribourg": {
    ...
    intro: "KAH Digital cr�e des sites web professionnels pour les entreprises, artisans et ind�pendants du canton de Fribourg. Bilingue fran�ais-allemand, nous comprenons les besoins sp�cifiques du march� fribourgeois. Sites haute-performance, SEO local, design premium. Starter d�s CHF 149 � Business d�s CHF 890 � Devis gratuit en 24h.",
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � Fribourg ?", a: "Starter (landing page bilingue FR/DE) d�s CHF 149, livr� en 5 jours. Business (6 pages, SEO) d�s CHF 890. Syst�me IA complet d�s CHF 1'690. Prix fixe, z�ro surprise." },
  ...
  "agence-web-berne": {
    ...
    intro: "KAH Digital accompagne les entreprises et ind�pendants de la r�gion bernoise dans leur pr�sence digitale. Bilingue fran�ais-allemand, notre studio est parfaitement adapt� aux besoins du march� bernois : f�d�ral, institutionnel, ou PME de proximit�. Starter d�s CHF 149 � Business d�s CHF 890 � Syst�me IA d�s CHF 1'690. Devis gratuit en 24h.",
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � Berne ?", a: "Starter (landing page bilingue FR/DE) d�s CHF 149, livr� en 5 jours. Business (6 pages, SEO) d�s CHF 890. Syst�me IA complet d�s CHF 1'690. Prix fixe, devis confirm� avant de commencer." },
  ...
  "agence-web-zurich": {
    ...
    intro: "KAH Digital accompagne les entreprises de Zurich dans leur pr�sence digitale. Zurich est la capitale �conomique suisse : banques, cabinets d'avocats, startups fintech, PME industrielles � notre studio cr�e des sites professionnels multilingues (DE/FR/EN) adapt�s au march� zurichois. Starter d�s CHF 149 � Business d�s CHF 890 � Syst�me IA d�s CHF 1'690. Devis gratuit en 24h.",
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � Zurich ?", a: "Starter (landing page) d�s CHF 149, livr� en 5 jours. Business (6 pages, SEO multilingue) d�s CHF 890. Syst�me IA complet d�s CHF 1'690. Prix fixe confirm� avant tout d�marrage." },
  ...
  "agence-web-basel": {
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � B�le ?", a: "Starter (landing page trilingue) d�s CHF 149, livr� en 5 jours. Business (6 pages, SEO dans 3 langues) d�s CHF 890. Syst�me IA complet d�s CHF 1'690. Prix fixe, z�ro surprise." },
  ...
  "agence-web-lugano": {
    ...
    faq: [
      { q: "Combien co�te un site web professionnel � Lugano ?", a: "Starter (landing page) d�s CHF 149, livr� en 5 jours. Business (6 pages, SEO) d�s CHF 890. Syst�me IA complet d�s CHF 1'690. Prix fixe, devis confirm� avant de commencer." },
