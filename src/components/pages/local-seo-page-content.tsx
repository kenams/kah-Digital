...
import { FiArrowRight, FiCheck, FiClock, FiMapPin, FiPhone, FiZap } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="py-20 text-center">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <Link
              href="/audit-gratuit"
              className="inline-flex items-center gap-2 rounded-full border border-white/20 px-8 py-4 font-semibold text-white transition hover:border-white/40 hover:bg-white/5"
            >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 flex gap-2 border-t border-white/10 bg-gray-950/95 px-4 py-3 backdrop-blur sm:hidden">
        ...
        <a
          href="tel:+33759558414"
          className="flex items-center justify-center gap-1.5 rounded-full border border-white/20 px-5 py-3 text-sm font-semibold text-white"
        >
          <FiPhone size={14} />
          Appeler
        </a>
