...
const copy = {
  ...
  de: {
    ...
    visuals: "Visual Output",
    visualsTitle: "Gelieferte Screens und visuelle Qualitaet.",
    nextEyebrow: "Naechster Schritt",
    nextTitle: "Brauchst du dieses Niveau auch fuer deine eigene Website?",
    nextBody: "KAH-Digital kann ein Label, eine Marke oder ein Projekt mit einer staerkeren Struktur, klaren Content-Pfaden und besserer Praesentation sauber ausarbeiten und online bringen.",
