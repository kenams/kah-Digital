        ...
        <div className="mx-auto max-w-7xl flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              aria-label="Lancer un batch de prospection"
            ...
            >
              <FiPlay size={13} /> {liveBatchRunning ? "Batch en cours..." : "Lancer un batch"}
            </button>
