...
const STORAGE_KEY = "kah_urgency_v3";

const copy = {
  fr: {
    msg: "⚡ 2 créneaux disponibles en juin · Prix fixe · Devis sous 24h",
    cta: "Démarrer →",
  },
  en: {
    msg: "⚡ 2 project slots left in June · Fixed price · Quote in 24h",
    cta: "Start →",
  },
  de: {
    msg: "⚡ 2 freie Plätze im Juni · Festpreis · Angebot in 24h",
    cta: "Starten →",
  },
} as const;
...
export function UrgencyBanner() {
  ...
  return (
    <div className="relative z-50 flex items-center justify-center gap-3 bg-gradient-to-r from-blue-700 via-violet-700 to-purple-700 px-10 py-2 text-center text-xs font-medium text-white sm:text-sm">
      ...
      <span className="sm:hidden">⚡ 2 créneaux juin · Prix fixe</span>
      <Link
        href={href}
