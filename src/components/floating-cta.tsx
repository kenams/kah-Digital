...
export function FloatingCTA() {
  ...
  return (
    <div
      className={`fixed bottom-6 left-4 right-4 z-40 flex justify-center gap-3 sm:left-6 sm:right-auto sm:justify-start ${
    ...
    >
      <a
        ...
        aria-label="WhatsApp"
        className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-2xl shadow-black/30 transition hover:brightness-110"
      >
