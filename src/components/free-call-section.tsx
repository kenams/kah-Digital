...
export function FreeCallSection() {
  ...
  const copy = locale === "en"
    ? {
        ...
        subtitle: "No pitch. No sales rep. Direct access to a senior — we review your project together and you leave with a clear plan.",
        items: ["Budget discussed & adapted to your reality", "Realistic guaranteed timeline", "Free tech advice", "Zero commitment"],
        cta: "Book 15 min on WhatsApp",
        waText: "Hi KAH Digital, I'd like to book a free 15-min discovery call to discuss my project.",
    ...
    ? {
        ...
        items: ["Budget besprochen & an Ihre Realität angepasst", "Realistischer, garantierter Zeitplan", "Kostenlose technische Beratung", "Keinerlei Verpflichtung"],
    ...
    : {
        ...
        subtitle: "Pas de pitch. Pas de commercial. Accès direct au senior KAH — on regarde votre projet ensemble et vous repartez avec un plan clair.",
        items: ["Budget discuté & adapté à votre réalité", "Délai réaliste garanti", "Conseils tech gratuits", "Zéro engagement"],
        cta: "Réserver 15 min sur WhatsApp",
        waText: "Bonjour KAH Digital, je voudrais réserver un appel découverte de 15 min pour discuter de mon projet.",
