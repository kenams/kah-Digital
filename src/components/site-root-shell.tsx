...
gtag('config', '${GA_MEASUREMENT_ID}');`}
        ...
        <SiteProviders>
          ...
          <a
            ...
            aria-label="WhatsApp"
            className="fixed bottom-20 left-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-green-500/30 transition-transform hover:scale-110"
          >
