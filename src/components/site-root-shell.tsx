...
gtag('config', '${GA_MEASUREMENT_ID}');`}
        ...
        <SiteProviders>
          ...
          {/* WhatsApp flottant */}
          <a
            href="https://wa.me/33759558414?text=Bonjour%2C%20je%20souhaite%20un%20devis%20pour%20mon%20projet%20web."
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="fixed bottom-24 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-green-500/30 transition-transform hover:scale-110 sm:bottom-6 sm:right-6"
          >
